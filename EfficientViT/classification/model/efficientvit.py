...
class EfficientViTBlock(torch.nn.Module):    
    ...
    def __init__(self, type,
        ...
        self.alpha = nn.Parameter(torch.tensor(0.5)) # added
        self.i = 0
    ...
    def forward(self, x):
        ...
        x = alpha * mixer_out + (1-alpha) * mxa_out # changed
        
        if self.i % 1000 == 0:
            print("Alpha:", alpha)
            print("Old mixer+mxa:", mixer_out+mxa_out)
            print("New mixer+mxa with alpha:", x)
